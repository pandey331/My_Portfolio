...
export const Contact= ()=>{
    return(
    <div id="contact" className="w-full h-screen bg-gradient-to-b from-gray to-gray-880 p-2 text-white">
        ...
        max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/ae0dfb7f-a60f-409b-996b-7ec008775c57 " method="POST" className="flex flex-col w-full md:w-1/2"> 
